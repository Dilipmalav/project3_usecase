	...
	<div>
		<form class="pb-5" action="<%=ORSView.PURCHASEORDER_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2"><%=HTMLUtility.getList2("product", String.valueOf(dto.getProduct()), map)%></div>
				...
				<div class="col-sm-2">
					<input type="text" name="totalCost" placeholder="Enter totalCost"
				...
				<div class="col-sm-2">
					<input type="text" name="orderDate" placeholder="Enter  orderDate"
						id="datepicker3" class="form-control" readonly="readonly"
